...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/o-0o/3x-ui/feature/dynamic-bandwidth-balancer/update.sh"
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/o-0o/3x-ui/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()
