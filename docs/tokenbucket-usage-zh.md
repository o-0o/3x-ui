...
```bash
v3.4.1-tokenbucket.2
```

Release 地址：

```text
https://github.com/o-0o/3x-ui/releases/tag/v3.4.1-tokenbucket.2
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/o-0o/3x-ui/feature/xray-core-tokenbucket-speed-limit/update.sh) v3.4.1-tokenbucket.2
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/o-0o/3x-ui/v3.4.1-tokenbucket.2/install.sh) v3.4.1-tokenbucket.2
```
...
例如当前版本是 `v3.4.1-tokenbucket.2`，下一版可以使用 `.3`：
