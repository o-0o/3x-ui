...
install_x-ui() {
    ...
    curl -4fLRo /usr/bin/x-ui-temp https://raw.githubusercontent.com/o-0o/3x-ui/${tag_version}/x-ui.sh
    if [[ $? -ne 0 ]]; then
    ...
    if [[ $release == "alpine" ]]; then
        ...
        if [ "$service_installed" = false ]; then
            ...
            case "${release}" in
                ubuntu | debian | armbian)
                    curl -4fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/o-0o/3x-ui/${tag_version}/x-ui.service.debian > /dev/null 2>&1
                    ;;
                arch | manjaro | parch)
                    curl -4fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/o-0o/3x-ui/${tag_version}/x-ui.service.arch > /dev/null 2>&1
                    ;;
                *)
                    curl -4fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/o-0o/3x-ui/${tag_version}/x-ui.service.rhel > /dev/null 2>&1
                    ;;
            esac
