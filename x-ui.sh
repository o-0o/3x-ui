...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/o-0o/3x-ui/feature/dynamic-bandwidth-balancer/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/o-0o/3x-ui/feature/dynamic-bandwidth-balancer/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/o-0o/3x-ui/feature/dynamic-bandwidth-balancer/x-ui.sh
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/o-0o/3x-ui/raw/feature/dynamic-bandwidth-balancer/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
